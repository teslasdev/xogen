  ...
  return (
    <div className="max-w-[1440px] mx-auto">
      ...
      <div className="flex p-[24px] justify-between">
        ...
        <div>
          <img src={xgStory} alt="Banner" className="h-[664px] w-[437.3px]" />
        </div>
      </div>
      ...
      <div className="w-full flex py-12 justify-center items-center">
        <div className=" text-center mt-6 flex flex-col justify-center items-center">
          ...
          <p className="font-[400] mt-3 text-[#120024] text-[24px]">
      ...
      <div className="py-24">
        ...
        <div className="w-full flex justify-between mt-4 gap-6">
          ...
          <div className="w-[386px]">
            <div className="h-[320px] bg-[#eee] rounded-[10px] w-full"></div>
            <h2 className="text-[40px] font-[700]">Amina B. – CTO</h2>
            <p className="text-[20px]">
          ...
          <div className="w-[386px]">
            <div className="h-[320px] bg-[#eee] rounded-[10px] w-full"></div>
            <h2 className="text-[40px] font-[700]">Chike N. – Product Lead</h2>
            <p className="text-[20px]">
      ...
      <div className="flex justify-between items-center w-full mt-6">
        <div className="text-center flex justify-between items-center w-full">
          <div>
            <img src={xgBulb} alt="Banner" className="h-[103px] w-full" />
            <p className="font-[500] mt-2 text-[20px]">Innovation</p>
          </div>

          <div>
            <img src={xgIntegrity} alt="Banner" className="h-[103px] w-full" />
            <p className="font-[500] mt-2 text-[20px]">Integrity</p>
          </div>

          <div>
            <img src={xgCollab} alt="Banner" className="h-[103px] w-full" />
            <p className="font-[500] mt-2 text-[20px]">Collaboration</p>
          </div>

          <div>
            <img src={xgExcel} alt="Banner" className="h-[103px] w-full" />
            <p className="font-[500] mt-2 text-[20px]">Excellence</p>
          </div>

          <div>
            <img src={xgCentric} alt="Banner" className="h-[103px] w-full" />
