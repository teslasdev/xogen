      ...
      <div className="w-full flex flex-col lg:min-h-[700px] justify-center items-center">
        ...
        <div className="lg:w-[900px] text-center mt-6 flex flex-col justify-center items-center">
          ...
          <p className="font-[400] text-[#120024] lg:text-[24px]">
            Discover how Xogen’s AI solutions can revolutionize various sectors.
            Our versatile technology adapts to your needs, offering innovative
            solutions across different industries. Explore how our products can
            be used to address specific challenges and drive success.
          </p>
        </div>
      </div>
