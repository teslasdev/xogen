...
const Whatwedo = () => {
  return (
    <div className="px-6 lg:px-0 max-w-[1440px] mx-auto">
      ...
      {/* Spec */}
      <div className="flex lg:p-[20px] py-12 flex-row-reverse flex-wrap items-center justify-between">
        <div className="w-[100%] lg:w-[40%]">
          <div className="flex gap-2">
            <h2 className="text-[28px] text-[#f22b0a] font-[700]">
              Technical Sales Engineering readiness
            </h2>
          </div>
          <p className="lg:text-[20px] font-[500] py-4 leading-[50px]">
      ...
      <div className="flex lg:p-[20px] py-12 flex-wrap items-center justify-between">
        <div className="w-[100%] lg:w-[40%]">
          <div className="flex gap-2">
            <h2 className="text-[28px] text-[#f22b0a] font-[700]">
      ...
      <div className="flex lg:p-[20px] py-12 flex-row-reverse flex-wrap items-center justify-between">
        <div className="w-[100%] lg:w-[40%]">
          <div className="flex gap-2">
            <h2 className="text-[28px] text-[#f22b0a] font-[700] lg:leading-[105.48px]">
            General Information
            </h2>
          </div>
          <p className="lg:text-[20px] font-[500] py-4 leading-[50px]">
